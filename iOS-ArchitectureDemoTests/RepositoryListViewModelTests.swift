...
class RepositoryListViewModelTests: XCTestCase {
    ...
    var githubService: RxGithubServiceMock!
    var viewModel: MVVMRxRepositoryListViewModel!
    ...
    override func setUp() {
        ...
        githubService = RxGithubServiceMock()
        viewModel = MVVMRxRepositoryListViewModel(initialLanguage: "Swift", githubService: githubService)
    }
